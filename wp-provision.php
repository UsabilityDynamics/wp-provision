...
include_once WP_Provision_Path . '/core/class_functions.php';

/** Loads all the metaboxes for the crm page */
include_once WP_Provision_Path . '/core/class_core.php';

// Register activation hook.
register_activation_hook( __FILE__, array( 'WP_Provision_Functions', 'activation' ));

// Register activation hook.
register_deactivation_hook( __FILE__, array( 'WP_Provision_Functions', 'deactivation' ));

// Initiate the plugin.
add_action( 'plugins_loaded', create_function('', 'new WP_Provision_Core;'));

// Register Resize.ly shortcode.
add_shortcode( 'resizely', array( 'WP_Provision_Functions', 'shortcode' ) );
